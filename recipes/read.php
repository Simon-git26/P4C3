...
$getData = $_GET;
// Verifier que la recette existe (id) et qu'il est numeric
...
// Faire la jointure sur recipe_id entre ma table recipes et ma table comments
// Selectionné recipes jointure gauche (externe) table comments liaison on recipe_id WHERE recipe_id = id des parametre
...
// Si la clé comment_id de mon commentaire n'est pas null, j'associe a la clé comments de mon tableau recipe les valeurs: 
